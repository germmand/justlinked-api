...
def run_with_dummy_data(fun: Callable):
    # It is required to set this 'GENERATE_DATA' variable since Alembic checks for it 
    # when running the migrations (see autogenerated versions files)
    # in case dummy data wants to be generated
    environ['GENERATE_DATA'] = "True"
    fun()
